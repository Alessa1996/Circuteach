  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          {{Form::open(array('url' => 'tdocumento/save'))}}
          <input type="hidden" name="tdo_cont" id="tdo_cont" value="">

          <div class="form-group col-md-6 col-sm-12">
            <label for="tdo_desc"> Descripción</label>
            <input type="text" name="tdo_desc" id="tdo_desc" value="" class="form-control">
          </div>
          ...
          <table class="datatable table table-striped" id="datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <center>
                    <a onclick="show({{ $data->tdo_cont}})" class="btn btn-warning btn-xs"> Ver/Actualizar</a>
                    <a onclick="del({{ $data->tdo_cont}})" class="btn btn-danger btn-xs"> Eliminar</a>
                  </center>
                </td>
              </tr>
              @empty
