<title>Todos Nuestros Videos Sobre Actividades</title>
        ...
        <div class="x_content">
          <div class="row">
            @forelse ($data as $data)
              <a href="{{ route('player',['env' => 'actividad','id' => sha1($data->act_cont)]) }}">
                ...
                <div class="col-md-12">
                  <div class="col-md-2 col-sm-4 col-sm-12" style=" vertical-align: middle; align-items: center;">
                    @if($data->act_img != null and $data->act_img != "")
                      <img src="{{asset('images/act_img/'.$data->act_img)}}" class="img-responsive" alt="...">

                    @else
                    <center>
                      <img src="{{asset('images/act_img/no_image.png')}}" class="img-responsive" alt="..." style="width: 160px; padding-top: 50px;" >
                    </center>
                    @endif
                  </div>
                  ...
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <h3>{{$data->act_titu}}</h3>
                    @php($terc = $data->ac_curs()->first()->ac_cate()->first()->gn_doce()->first()->gn_terc()->first())
                    @php($nombre = $terc->ter_pnom." ".$terc->ter_snom." ".$terc->ter_pape." ".$terc->ter_sape)
                    <p>{!! nl2br($data->act_desc) !!}</p>
                  ...
                  <a href="{{route('player',['env' => 'actividad','id' => sha1($data->act_cont)])}}" class="btn btn-primary pull-right"> Abrir / Ver</a>
                </div>
