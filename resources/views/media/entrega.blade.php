<title>Todos Nuestros Videos Sobre Entregas</title>
...
<div class="">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Videos - Entregas por Actividades</h2>
        ...
        <div class="x_content">
          <div class="row">
            @forelse ($data as $data)
              <a href="{{ route('player',['env' => 'entrega','id' => sha1($data->ent_cont)]) }}">
                ...
                <div class="col-md-12">
                  <div class="col-md-2 col-sm-4 col-sm-12" style=" vertical-align: middle; align-items: center;">
                    @if($data->ent_img != null and $data->ent_img != "")
                      <img src="{{asset('images/ent_img/'.$data->ent_img)}}" class="img-responsive" alt="...">

                    @else
                    <center>
                      <img src="{{asset('images/ent_img/no_image.png')}}" class="img-responsive" alt="..." style="width: 160px; padding-top: 50px;" >
                    </center>
                    @endif
                  </div>
                  ...
                  <a href="{{route('player',['env' => 'entrega','id' => sha1($data->ent_cont)])}}" class="btn btn-primary pull-right"> Abrir / Ver</a>
                </div>
