           ...
           <div class="left_col scroll-view">
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="{{asset('images/profile/admin.png')}}" alt="..." class="img-circle profile_img">
              </div>
             ...
             <div class="menu_section">
              ...
              <div class="menu_section">
               ...
               <div class="menu_section">
                 <h3>Administrador</h3>
                 <ul class="nav side-menu">
                   <li><a><i class="fa fa-eye"></i> Apariencia <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                       <li><a href="{{route('home')}}">Módulos de Visualización</a></li>
                     </ul>
                   </li>

                   <li><a><i class="fa fa-cogs"></i> Parámetros Iniciales <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                       <li><a href="{{route('tdoindex') }}">Tipo de Documento</a></li>
                       <li><a href="{{route('tusindex') }}">Tipo de Usuario</a></li>
                       <li><a href="{{route('nacindex') }}">Niveles Académicos</a></li>
                     </ul>
                   </li>

                   <li><a><i class="fa fa-users"></i> Gestión de Personal <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                       <li><a href="{{route('terindex') }}">Gestión de Personas</a></li>
                       <li><a href="{{route('docindex') }}"> Docentes</a></li>
                       <li><a href="{{route('estindex') }}"> Estudiantes</a></li>
                       <li><a href="{{route('admindex') }}">Administradores de Sistema</a></li>
                     </ul>
                   </li>

                   <li><a><i class="fa fa-graduation-cap"></i> Gestión Académica <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                       <li><a href="{{route('asiindex') }}"> Asignatura</a></li>
                       <li><a href="{{route('catindex') }}"> Relación de Cátedras</a></li>
                     </ul>
                   </li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Lock">
                <span class="glyphicon glyphicon-eye-open" aria-hidden="true" href="{{route('home')}}"></span>
              </a>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{asset('images/profile/admin.png')}}" alt="">
                    {{ Session::get("user") }}
                ...
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="{{route('profile',['profile' => 'administrador'])}}"><i class="fa fa-cogs pull-right"></i> Administrador</a></li>
                    <li><a href="{{route('profile',['profile' => 'docente'])}}"><i class="fa fa-book pull-right"></i> Docente</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
